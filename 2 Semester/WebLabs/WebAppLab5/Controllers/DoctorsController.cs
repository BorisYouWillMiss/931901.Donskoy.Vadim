...
namespace WebAppLab5.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public DoctorsController(WebAppLab5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Doctor != null ? 
                          ...
                          Problem("Entity set 'WebAppLab5Context.Doctor'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,name,address,phone")] Doctor doctor)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAppLab5Context.Doctor'  is null.");
            }
            var doctor = await _context.Doctor.FindAsync(id);
            if (doctor != null)
            {

...
namespace WebAppLab5.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public HospitalsController(WebAppLab5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Hospital != null ? 
                          ...
                          Problem("Entity set 'WebAppLab5Context.Hospital'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAppLab5Context.Hospital'  is null.");
            }
            var hospital = await _context.Hospital.FindAsync(id);
            if (hospital != null)
            {
